...
.sidebar_container_border() {
	<?php echo $GLOBALS[WPPS_PREFIX.'admin_interface']->generate_border_css( $sidebar_search_box_border ); ?>
}
.sidebar_container_shadow() {
	<?php echo $GLOBALS[WPPS_PREFIX.'admin_interface']->generate_shadow_css( $sidebar_search_box_shadow ); ?>
}
...
.sidebar_cat_label_font() {
	<?php echo $GLOBALS[WPPS_PREFIX.'fonts_face']->generate_font_css( $sidebar_category_dropdown_font ); ?>
}
.sidebar_cat_side_border() {
<?php if ( 'left' === $sidebar_category_dropdown_align ) { ?>
	border-left: none;
	<?php echo str_replace( 'border:', 'border-right:', $GLOBALS[WPPS_PREFIX.'admin_interface']->generate_border_style_css( $sidebar_category_dropdown_side_border ) ) ; ?>
<?php } else { ?>
	border-right: none;
	<?php echo str_replace( 'border:', 'border-left:', $GLOBALS[WPPS_PREFIX.'admin_interface']->generate_border_style_css( $sidebar_category_dropdown_side_border ) ) ; ?>
<?php } ?>
}
...
<?php if ( 'left' === $sidebar_category_dropdown_align ) { ?>
	border-right: none;
	<?php echo str_replace( 'border:', 'border-left:', $GLOBALS[WPPS_PREFIX.'admin_interface']->generate_border_style_css( $sidebar_search_icon_side_border ) ) ; ?>
<?php } else { ?>
	border-left: none;
	<?php echo str_replace( 'border:', 'border-right:', $GLOBALS[WPPS_PREFIX.'admin_interface']->generate_border_style_css( $sidebar_search_icon_side_border ) ) ; ?>
<?php } ?>
}
...
.sidebar_input_bg_color {
	<?php echo $GLOBALS[WPPS_PREFIX.'admin_interface']->generate_background_color_css( $sidebar_input_bg_color ); ?>
}
.sidebar_input_font() {
	<?php echo $GLOBALS[WPPS_PREFIX.'fonts_face']->generate_font_css( $sidebar_input_font ); ?>
}
...
.sidebar_popup_border() {
	<?php echo $GLOBALS[WPPS_PREFIX.'admin_interface']->generate_border_css( $sidebar_popup_border ); ?>
}
...
.sidebar_popup_heading_font() {
	<?php echo $GLOBALS[WPPS_PREFIX.'fonts_face']->generate_font_css( $sidebar_popup_heading_font ); ?>
}
.sidebar_popup_heading_border() {
	<?php echo str_replace( 'border:', 'border-bottom:', $GLOBALS[WPPS_PREFIX.'admin_interface']->generate_border_style_css( $sidebar_popup_heading_border ) ) ; ?>
}
...
.sidebar_popup_item_border() {
	<?php echo str_replace( 'border:', 'border-bottom:', $GLOBALS[WPPS_PREFIX.'admin_interface']->generate_border_style_css( $sidebar_popup_item_border ) ) ; ?>
}
...
@sidebar_popup_item_name_hover_color: <?php echo $sidebar_popup_item_name_hover_color; ?>;
.sidebar_popup_item_name_font() {
	<?php echo $GLOBALS[WPPS_PREFIX.'fonts_face']->generate_font_css( $sidebar_popup_item_name_font ); ?>
}
@sidebar_popup_item_desc_hover_color: <?php echo $sidebar_popup_item_desc_hover_color; ?>;
.sidebar_popup_item_desc_font() {
	<?php echo $GLOBALS[WPPS_PREFIX.'fonts_face']->generate_font_css( $sidebar_popup_item_desc_font ); ?>
}
@sidebar_popup_item_category_color: <?php echo $sidebar_popup_item_category_color; ?>;
@sidebar_popup_item_category_link_hover_color: <?php echo $sidebar_popup_item_category_link_hover_color; ?>;
@sidebar_popup_item_category_hover_color: <?php echo $sidebar_popup_item_category_hover_color; ?>;
.sidebar_popup_item_category_font() {
	<?php echo $GLOBALS[WPPS_PREFIX.'fonts_face']->generate_font_css( $sidebar_popup_item_category_font ); ?>
}
...
.sidebar_popup_seemore_font() {
	<?php echo $GLOBALS[WPPS_PREFIX.'fonts_face']->generate_font_css( $sidebar_popup_seemore_font ); ?>
}
.sidebar_popup_more_link_font() {
	<?php echo $GLOBALS[WPPS_PREFIX.'fonts_face']->generate_font_css( $sidebar_popup_more_link_font ); ?>
}

...
class Sidebar_Template extends FrameWork\Admin_UI
{
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Widget Template Settings successfully saved.' ),
				'error_message'		=> __( 'Error: Widget Template Settings can not save.' ),
				'reset_message'		=> __( 'Widget Template Settings successfully reseted.' ),
			);
